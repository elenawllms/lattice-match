...
# GLOBAL VARIABLES ----
API_KEY = "yLKJat5uDtkVnA5UkLNwGQVWUjg99Prg"
...
# SUBSTRATE / FILM DATA ----
sublattices_2d = pd.read_csv("data/sublattices_2d.csv")
sublattices_1d = pd.read_csv("data/sublattices_1d.csv")

substrates = pd.concat([sublattices_2d["substrate"], sublattices_1d["substrate"]]).unique()

films_2d = pd.read_csv("data/stable_films_2d.csv")
films_1d = pd.read_csv("data/stable_films_1d.csv")
